...
<section class="content">
    ...
    <a href="?pg=setoran&act=add"> <button type="button" class="btn btn-info"><i class = "fa fa-plus"> Tambah Data </i></button> </a>
    </div><!-- /.box-header -->
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                       ...
                       <td><?php echo "Rp.". number_format("$r[harga_setor]",'0','.','.')?></td>
                        ...
                        <td><a href="?pg=setoran&act=edit&id=<?php echo $r['id_setor']?>"><button type="button" class="btn bg-orange"><i class="fa fa-pencil-square-o"></i></button></a></td>
                        <td><a href="?pg=setoran&act=delete&id=<?php echo $r['id_setor']?>"><button type="button" class="btn btn-danger" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class = "fa fa-trash-o"></i></button></a></td>
                        </tr>
						<?php
                    $no++;
                    }
...
<section class="content">
  <div class="row">
    ...
    <!-- /.row (main row) -->
      ...
      case 'edit':
      $d = mysql_fetch_array(mysql_query("SELECT * FROM tb_setor WHERE id_setor='$_GET[id]'"));
            if (isset($_POST['update'])) {
                ...
                echo "<script>window.location='?pg=setoran&act=view'</script>";
          }
              ?>
...
<div class="content-wrapper">
        ...
        <h1> Data Pengguna </h1>
            <ol class="breadcrumb">
            <li><a href="?pg=dashboard"><i class="fa fa-dashboard"></i> Beranda</a></li>
            <li class="active"><a href="?pg=setoran&act=view">Data Produk</a></li>
